...
## Documentation
- [Quick Start Guide](docs/QUICK_START.md) - For setting up the environment from scratch.
- [Distributed Deployment Guide](docs/DISTRIBUTED_DEPLOYMENT.md) - **Deprecated**. See specific guides below.
- [CogVLM2 Colab Setup](docs/COGVLM_COLAB_SETUP.md) - Setting up the LLM inference service.
- [OpenSeeD Colab Setup](docs/OPENSEED_COLAB_SETUP.md) - Setting up the vision inference service.
- [Local Run Guide](docs/LOCAL_RUN_SETUP.md) - How to run the agent locally connecting to remote services.
