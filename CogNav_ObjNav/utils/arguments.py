...
def get_args():
    ...
    parser.add_argument('--auto_gpu_config', type=int, default=0) # 1
    ...
    parser.add_argument('--save_interval', type=int, default=1,
                        help="""save interval""")
    parser.add_argument('-d', '--dump_location', type=str, default="results/",
    ...
    parser.add_argument('--path_detection_config', type=str, default='./configs/detection/HM3D.yaml')
    ...
    parser.add_argument('--skip_times', type=int, default=4)
    parser.add_argument('--cog_model_path', type=str, default="model/pretained_model/cogvlm2-llama3-chat-19B")
    parser.add_argument('--scenes', nargs='*', default=['bCPU9suPUw9','bxsVRursffK'], help='A list of zero or more elements')
...
def load_opt_command():

    opt = load_opt_from_config_files(['configs/openseed/openseed_swinl_lang_decouple.yaml'])
    overrides=['WEIGHT', 'openseed_swinl_pano_sota.pt']
    if overrides:
