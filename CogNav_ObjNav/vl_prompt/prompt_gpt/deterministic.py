...
(6) If you cannot make a concrete decision, just pick one number from the candidates, which is the farest from current agent location.

(7) If there are no current frontiers, skip the thought and pick one number from the candidates, which is the farest from current agent location.
