...
from utils.constants import category_to_id, mp3d_category_id
import envs.utils.pose as pu

coco_categories = [0, 3, 2, 4, 5, 1]


class ObjectGoal_Env_hm3d(habitat.RLEnv):
    ...
    def reset(self):
        ...
        self.info['current_episode.scene_id'] = self._env.current_episode.scene_id
    ...
    def step(self, action):
        ...
        obs, rew, done, _ = super().step(action) # 观测、奖励、是否完成、信息
